...
class CreateAreasTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('area_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'area');
        ...
        Schema::create('area_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'area');
        });

        // remove this if you're not going to use revisions, ie. using the HasRevisions trait
        Schema::create('area_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'area');
        });
    }

    public function down()
    {
        Schema::dropIfExists('area_revisions');
        Schema::dropIfExists('area_translations');
        Schema::dropIfExists('area_slugs');
