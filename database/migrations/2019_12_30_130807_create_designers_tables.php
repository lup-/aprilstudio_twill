...
class CreateDesignersTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('designer_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'designer');
        ...
        Schema::create('designer_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'designer');
        });

        // remove this if you're not going to use revisions, ie. using the HasRevisions trait
        Schema::create('designer_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'designer');
        });
    }

    public function down()
    {
        Schema::dropIfExists('designer_revisions');
        Schema::dropIfExists('designer_translations');
        Schema::dropIfExists('designer_slugs');
