...
class CreateTypesTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('type_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'type');
        ...
        Schema::create('type_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'type');
        });

        // remove this if you're not going to use revisions, ie. using the HasRevisions trait
        Schema::create('type_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'type');
        });
    }

    public function down()
    {
        Schema::dropIfExists('type_revisions');
        Schema::dropIfExists('type_translations');
        Schema::dropIfExists('type_slugs');
