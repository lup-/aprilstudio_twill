...
<!-- main welcome page -->
    ...
    <header>
        <div class="logo rotate">
            <div class="logo_forDay"><img src="/images/logounion4_orange.svg" alt="Union4"></div>
            <div class="logo_forNight"><img src="/images/logounion4_white.svg" alt="Union4"></div>
        </div>
...
<div class="lead_welcome">

<!-- owl carousel. Part 2/3 -->
<div class="owl-carousel">
    @foreach ($favouriteWorks as $chunk)
        @include('site.work_chunk_carousel', ['chunk' => $chunk, 'loop' => $loop])
    @endforeach
</div>
<!-- \ owl carousel. Part 2/3 -->
